...
## <img src="pictures/test_pics/settings.png" width="24" height="24" style="vertical-align:middle; margin-right:8px;"> Cấu hình Firebase
...
***
### Bệnh **Strawberry Healthy** (Bệnh Cháy rụi lá dâu tây)
...
***
### **Cherry Powdery Mildew** (Bệnh Phấn trắng trên cây anh đào)
...
***
### Video **Bệnh Phấn trắng trên cây anh đào** (Thực hiện đọc âm thanh từ kết quả chuẩn đoán - text-to-speech)
